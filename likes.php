					...
					<nav class="navbar" style="background: #F8F8F8;" >
						<div class="container-fluid">
						    <ul class="nav navbar-nav">
						    	...
						    	<li><a href="likes.php" style="font-weight: bolder;font-size: 16px;text-decoration: none; color: #1DA1F2;">LIKES</a></li>
	...
	<div class="container" style="margin-top: 120px;">
		<div class="col-xs-12">
			...
			<div class="col-xs-6" style="float: left;">
				...
				<?php
					$query = 'match (u:User) - [:likes] -> (t:Tweet) where u.name ="'. $user .'" return t';
					$result = $client->sendCypherQuery($query)->getResult();
					$temp = $result->get('t');
					$tempsize = count($temp);
					// echo $tempsize;
					...
					if ($tempsize == 0) {
						...
						echo '<p>'.$user.' has not liked any tweets</p>';
						echo '</div>';
						echo '</div>';
					}
					else if ($tempsize == 1) {
