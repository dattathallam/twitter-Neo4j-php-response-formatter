					...
					<nav class="navbar" style="background: #F8F8F8;" >
						<div class="container-fluid">
						    <ul class="nav navbar-nav">
						    	...
						    	<li><a href="followers.php" style="font-weight: bolder;font-size: 16px;text-decoration: none; color: #1DA1F2;">FOLLOWERS</a></li>
...
<body>
	<div class="container" style="margin-top: 120px;">
		<div class="col-xs-12">
			...
			<div class="col-xs-6">
				<?php
					$query = 'match (u:User) - [:follows] -> (v:User) where v.name ="'. $user .'" return u';
					$result = $client->sendCypherQuery($query)->getResult();
					$temp = $result->get('u');
					$tempsize = count($temp);
					// echo $tempsize;
				...
				?> 
						...
						<button type="button" style="float: right;width:100px "  class="btn btn-success" 
							 onmouseover="this.innerHTML='<?php if($a == "Follow"){ echo "Follow";} else { echo "Unfollow"; }?>'" 
							 onmouseout="this.innerHTML='<?php echo $a; ?>';"
							 onclick="document.location.href='folr.php?id1=<?php echo $uid;?>'">
							 <?php echo $a; ?>
